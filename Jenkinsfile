            ...
            steps {
                script{
                    //sh 'sonar-scanner -Dsonar.projectKey=blog-clone0 -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000  -Dsonar.token=sqp_9b3c17ee03b8c9126897776e58f3636058beebc9'
                     sh 'docker run --rm -v $PWD:/usr/src -w /usr/src sonarsource/sonar-scanner-cli sonar-scanner -Dsonar.projectKey=blog-clone0 -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000 -Dsonar.login=sqp_9b3c17ee03b8c9126897776e58f3636058beebc9'
